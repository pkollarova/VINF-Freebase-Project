...
'''
This mapper is used to process a freebase file from which it obtains all information about the music tracks.
At the same time, it cleans the lines of the freebase file so that we can search better.
We are looking for their specific IDs, length and names or labels.
'''
