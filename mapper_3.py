...
'''
This mapper is used to process a freebase file from which it obtains all information about the won awards.
At the same time, it cleans the lines of the freebase file so that we can search better.
We are looking for their specific IDs, description, honor year and names or labels.
'''
