...
'''
This reducer is used to process sorted data from the second mapper.
It does line by line and puts information about specific artists track together into a chunk.
'''
