...
'''
This reducer is used to process sorted data from the third mapper.
It does line by line and puts information about specific artists award together into a chunk.
'''
